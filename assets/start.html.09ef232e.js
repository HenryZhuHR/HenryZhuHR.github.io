import{b as a}from"./app.86d8f235.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const e={},n=a(`<p>Before going any further, make sure your system meets all the <a href="/install/requirements">requirements</a>.</p><blockquote><p>Looking for a complete, easy step-by-step installation guide, including all dependencies and an auto-updater? Check out the <a href="/install/ubuntu">Ubuntu-based</a> installation guide. {.is-info}</p></blockquote><h2 id="\u5B89\u88C5" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5" aria-hidden="true">#</a> \u5B89\u88C5</h2><p>\u4E0B\u8F7D\u6700\u65B0\u7684 <a href="https://github.com/Requarks/wiki/releases" target="_blank" rel="noopener noreferrer">wiki.js</a></p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">wget</span> c/download/wiki-js.tar.gz
