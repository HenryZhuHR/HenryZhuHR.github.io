import{b as a}from"./app.cdc06c7c.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const e={},n=a(`<p>Before going any further, make sure your system meets all the <a href="/install/requirements" target="_blank" rel="noopener noreferrer">requirements</a>.</p><blockquote><p>Looking for a complete, easy step-by-step installation guide, including all dependencies and an auto-updater? Check out the <a href="/install/ubuntu" target="_blank" rel="noopener noreferrer">Ubuntu-based</a> installation guide. {.is-info}</p></blockquote><h2 id="\u5B89\u88C5" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5" aria-hidden="true">#</a> \u5B89\u88C5</h2><p>\u4E0B\u8F7D\u6700\u65B0\u7684 <a href="https://github.com/Requarks/wiki/releases" target="_blank" rel="noopener noreferrer">wiki.js</a></p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">wget</span> c/download/wiki-js.tar.gz
...
</code></pre></div><p><em>Note:</em> You can see the logs of the service using <code>journalctl -u wiki</code></p><p><img src="https://a.icons8.com/TqgWTTfw/Oy7xHF/svg.svg" alt="">{.align-abstopright}</p>`,28);function t(o,l){return n}var c=s(e,[["render",t]]);export{c as default};
